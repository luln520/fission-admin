...
return [
    ...
    "个人"=>"personal",
    "发行单价"=>"Issuing unit price",
    "标记成功" => "Marking succeeded",
    "操作成功" => "Operation succeeded",
    "全球公司拥有多种功能，使其成为买卖数字资产的理想场所" => "Global companies have multiple functions, making them ideal places to buy and sell digital assets",
    "建仓" => "buy",
    "会员列表" => "Member List",
    "新币认购记录" => "New currency subscription record",
    ...
    "正在结算中" => "Billing",
    "继续下单" => "continue",
    "您的账户已被禁止交易，请联系客服"=>"Your account has been prohibited from trading, please contact customer service.",
    ...
    '正在加载中' => 'Loading',
    '再试一次' => 'Try again',
	'已禁止提现'=>'Withdrawal disabled',
	'提币地址太长'=>'Withdrawal address is too long',
