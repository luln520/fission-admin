	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b" style="background:#fff;">
	                        ...
	                        <a data-bn-type="link" href="<?php echo U('Contract/contractpc');?>" class="css-6ijtmk" style="background:#f5f5f5;">
	                            <div class="css-10j588g">
	                   ...
	                   <div class="css-1wr4jig" style="background:#fff;">
	                       <div class="css-6ul7zn">
	                           <div class="css-joa6mv">
	                               <div data-bn-type="text" class="css-1868gi1"><?php echo L('已平仓合约');?></div>
	                           </div>
	                               ...
	                               <div class="css-jjjwcg">
	                                   <div class="css-15owl46">
	                                       <div class="btitle">
	                                           ...
	                                           <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('交易限价');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:12%;">
	                                               <span class="fch f14"><?php echo L('成交单价');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:17%;">
	                                               <span class="fch f14"><?php echo L('建仓时间');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:17%;">
	                                               <span class="fch f14"><?php echo L('平仓时间');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('盈亏金额');?></span>
	                                           </div>
	                                       </div>
	                                       <div style="width:100%;height:400px;overflow: auto;">
	                                           ...
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width:100%;height:60px;background:#fff;border-bottom:1px solid #f5f5f5;">
	                                                ...
	                                                <div class="bcontentop" style="width:12%;">
	                                                    <span class="fch f14"><?php echo ($vo["sellprice"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:17%;">
	                                                    <span class="fch f14"><?php echo ($vo["buytime"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:17%;">
	                                                    <span class="fch f14"><?php echo ($vo["selltime"]); ?></span>
	                                                </div>
	                                                <div class="btitleop" style="width:10%;">
	                                                    <?php if($vo["is_win"] == 1): ?><span class="fch f14 fgreen"> +<?php echo ($vo["ploss"]); ?></span>
	                                                    <?php elseif($vo["is_win"] == 2): ?>
	                                                    <span class="fch f14 fred"> -<?php echo ($vo["ploss"]); ?></span><?php endif; ?>
	                                                </div>
