                    ...
                    <div class="css-uliqdc">
                        <div style="min-height: 500px;background: rgb(245, 245, 245);padding: 0px 15%;display: block;">
                            ...
                            <?php if(empty($list)): ?><div style="width:100%;height:400px;line-height:400px;text-align:center;">
	                         ...
	                         <?php else: ?>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width:100%;height:320px;background:#fff;margin-bottom:20px;box-shadow: 0 2px 10px 0 rgb(0 0 0 / 10%);border-radius:5px;">
                                        ...
                                        <div style="width:100%;height:240px;background:#fff;">
                                            <div style="width:100%;height:230px;">
                                                ...
                                                <div style="width:75%;padding:10px 0px 10px 10px;float:right;">
                                                    ...
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('发行单价');?>：<?php echo ($vo["yuan_price"]); ?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
