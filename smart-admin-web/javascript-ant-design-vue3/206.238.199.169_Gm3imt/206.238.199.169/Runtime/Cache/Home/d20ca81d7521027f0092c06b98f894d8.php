	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b" style="background:#fff;">
	                        ...
	                        <a data-bn-type="link" href="<?php echo U('Contract/contractjc');?>" class="css-6ijtmk" style="background:#f5f5f5;">
	                            <div class="css-10j588g">
	                        ...
	                        <a data-bn-type="link" href="<?php echo U('Issue/overdueissue');?>" class="css-6ijtmk">
	                            <div class="css-10j588g">
	                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="css-hd27fe"><path d="M18.731 13.827a1.741 1.741 0 011.456.518c.68.68.792 1.823.305 2.758-1.266 2.438-4.209 4.667-8.034 4.878-3.062.17-6.148-.807-9.24-2.902l1.008-1.486c2.782 1.887 5.488 2.743 8.133 2.597 3.135-.174 5.547-2.001 6.541-3.914.143-.274.114-.568.018-.664-.041-.04-.182-.026-.581.337-2.667 2.498-6.129 3.072-10.251 1.75l.547-1.71c1.279.41 2.458.612 3.545.607-2.398-1.845-5.124-1.907-8.335-.195L3 14.818c.463-.249.94-.471 1.427-.668a8.242 8.242 0 01-1.005-3.962C3.422 5.667 7.037 2 11.496 2s8.074 3.667 8.074 8.188a8.245 8.245 0 01-.839 3.639zm-12.549-.229c2.97-.666 5.668.126 8.01 2.369 2.14-1.036 3.584-3.257 3.584-5.778 0-3.538-2.817-6.395-6.28-6.395s-6.28 2.858-6.28 6.394c0 1.23.34 2.403.966 3.41z" fill="#00b897"></path><path d="M9.5 9.5l2-2 2 2-2 2-2-2z" fill="#00b897"></path></svg>
	                   ...
	                   <div class="css-1wr4jig" style="background:#fff;">
	                       <div class="css-6ul7zn">
	                           <div class="css-joa6mv">
	                               <div data-bn-type="text" class="css-1868gi1"><?php echo L('未平仓合约');?></div>
	                           </div>
	                                   ...
	                                   <div class="css-15owl46">
	                                       <div class="btitle">
	                                           <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14">ID</span>
	                                           </div>
	                                           <div class="btitleop" style="width:15%;">
	                                               <span class="fch f14"><?php echo L('交易对');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('方向');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:10%">
	                                               <span class="fch f14"><?php echo L('状态');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('委托额度');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:15%;">
	                                               <span class="fch f14"><?php echo L('建仓单价');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:20%;">
	                                               <span class="fch f14"><?php echo L('建仓时间');?></span>
	                                           </div>
	                                            <div class="btitleop" style="width:8%;">
	                                               <span class="fch f14"><?php echo L('倒计时');?></span>
	                                           </div>
	                                       </div>
	                                       
	                                       
	                                       
	                                       <div id="list_box" style="width:100%;height:400px;overflow: auto;">
	                                           ...
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width:100%;height:60px;background:#fff;border-bottom:1px solid #f5f5f5;">
	                                                 <div class="bcontentop" style="width:10%;">
	                                                     <span class="fch f14"><?php echo ($vo["id"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
	                                                    <span class="fch f14"><?php echo ($vo["coinname"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:10%;">
	                                                    <?php if($vo["hyzd"] == 1): ?><span class="f14 fw fgreen"><?php echo L('买涨');?></span>
		                                                <?php elseif($vo["hyzd"] == 2): ?>
		                                                <span class="f14 fw fred"><?php echo L('买跌');?></span><?php endif; ?>
	
	                                                </div>
	                                                <div class="bcontentop" style="width:10%">
	                                                    <?php if($vo["status"] == 1): ?><span class="fch f14"><?php echo L('待结算');?></span>
	                                                    <?php elseif($vo["status"] == 2): ?>
	                                                    <span class="fch f14"><?php echo L('已结算');?></span>
	                                                    <?php elseif($vo["status"] == 3): ?>
	                                                    <span class="fch f14"><?php echo L('无效单');?></span><?php endif; ?>
	                                                </div>
	                                                <div class="bcontentop" style="width:10%;">
	                                                    <span class="fch f14"><?php echo ($vo["num"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
	                                                    <span class="fch f14"><?php echo ($vo["buyprice"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:20%;">
	                                                    <span class="fch f14"><?php echo ($vo["buytime"]); ?></span>
	                                                </div>
	                                                
	                                                <div class="bcontentop" style="width:8%;">
	                                                    <span class="fch f14" style="font-size:20px;color:#00b897">60</span>
	                                                </div>
        ...
        function(data){
            if(data.code == 1){
                ...
                if(data.data == '' || data.data == null){
		            html = '<div style="width:100%;height:400px;line-height:400px;text-align:center;">'+
	                       '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" fill="none" class="mirror css-1lzksdc">'+
	                       '<path fill-rule="evenodd" clip-rule="evenodd" d="M64 8H26v80h58V28L64 8zM36 37h38v4H36v-4zm0 9h38v4H36v-4zm38 9H36v4h38v-4z" fill="url(#not-found-data-light_svg__paint0_linear)"></path>'+
	                       '<path d="M62 71l4-4 4 4-4 4-4-4z" fill="#fff"></path>'+
	                       '<path d="M86 50l3-3 3 3-3 3-3-3zM47 21l3-3 3 3-3 3-3-3zM84 28H64V8l20 20z" fill="#E6E8EA"></path>'+
	                       '<path fill-rule="evenodd" clip-rule="evenodd" d="M4.171 73.171l14.5-14.5 5.657 5.658-14.5 14.5-5.657-5.657z" fill="url(#not-found-data-light_svg__paint1_linear)"></path>'+
	                       '<path fill-rule="evenodd" clip-rule="evenodd" d="M51 48c0-8.837-7.163-16-16-16s-16 7.163-16 16 7.163 16 16 16 16-7.163 16-16zm4 0c0-11.046-8.954-20-20-20s-20 8.954-20 20 8.954 20 20 20 20-8.954 20-20z" fill="url(#not-found-data-light_svg__paint2_linear)"></path>'+
	                       '<defs>'+
                    ...
                    $.each(data.data,function(key,val){
                        html += '<div style="width:100%;height:60px;background:#fff;border-bottom:1px solid #f5f5f5;">'+
	                            '<div class="bcontentop" style="width:10%;">'+
	                            '<span class="fch f14">'+ val.id +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:15%;">'+
	                            '<span class="fch f14">'+ val.coinanme +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:10%;">'+
		                        '<span class="f14 fw fgreen">'+ val.hyzdstr +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:10%">'+
	                            '<span class="fch f14">'+ val.statusstr +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:10%;">'+
	                            '<span class="fch f14">'+ val.num +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:15%;">'+
	                            '<span class="fch f14">'+ val.buyprice +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:20%;">'+
	                            '<span class="fch f14">'+ val.buytime +'</span>'+
	                            '</div>'+
	                            '<div class="bcontentop" style="width:8%;">'+
	                            '<span class="fch f14" style="font-size:20px;color:#00b897">'+ val.t +'</span>'+
	                            '</div>'+
	                            '</div>';
