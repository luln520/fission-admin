...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Config/ctmarket');?>">市场配置</a> &gt;&gt;</span>
            <span class="h1-title"><?php if(empty($data)): ?>新增市场配置<?php else: ?>编辑市场配置<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Config/ctmarketEdit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls" >
									...
									<td>
										<input type="text" class="form-control input-10x" name="coinname" value="<?php echo ($data["coinname"]); ?>">
									</td>
