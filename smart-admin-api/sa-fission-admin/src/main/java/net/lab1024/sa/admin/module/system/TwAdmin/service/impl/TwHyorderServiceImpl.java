...
//        queryWrapper.eq("status", 1); // 添加查询条件
    ...
    @Override
    public ResponseDTO creatorder(int uid, String ctime, BigDecimal ctzed, String ccoinname, int ctzfx, BigDecimal cykbl,String language, String plantime,boolean isFollowMode) {
...
//        twBillService.save(twBill);
    ...
    public void settlement(String orderNo) {
        ...
        if(twHyorder != null) {
            if(twHyorder.getOrderType() == 1) {
                settlementOrder(twHyorder);
            }else {
    ...
    private void settlementOrder(TwHyorder twHyorder) {
