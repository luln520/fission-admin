...
public class AdminSwaggerTagConst extends SwaggerTagConst {
    ...
    public static class PC {
        ...
        public static final String PC_CURRENCY = "PC-货币";

        public static final String PC_BILL = "PC-账单";

        public static final String PC_AREA = "PC-区域";
        ...
        public static final String PC_C2C = "PC-C2C管理";
        ...
        public static final String PC_FOLLOW = "PC-跟单";

        public static final String PC_USER_INVITE = "PC-用户邀请";
