...
public class PcCodeController {
    ...
    @NoNeedLogin
    public ResponseDTO code(@RequestParam String username,@RequestParam int type,@RequestParam String language) throws IOException {
        return twUserService.code(username,type,language);
    }
